...
Now for the fun part -- it's time to try out the add-in that you've built.
...
1. In the **Choose a room** section of the task pane, choose **Conference Room Carter** from the list and press **Select**. The meeting contains a total of 2 attendees (1 invitee + the organizer) and occurs in the AM hours of October 1.
...
1. Add another recipient to the **To...** field of the meeting invite. The meeting now contains a total of 3 attendees (2 invitees + the organizer) and occurs in the AM hours of October 1.
...
1. In the **Choose a room** section of the task pane, choose **Conference Room Johnson** from the list and press **Select**. The meeting still contains a total of 3 attendees (2 invitees + the organizer) and occurs in the AM hours of October 1.
 ...
 1. Change the **Start time** of the meeting to **2:00pm**. (The **End time** automatically adjusts to **3:00pm** since meeting duration is one hour.) The meeting still contains a total of 3 attendees (2 invitees + the organizer), but now occurs in the PM hours of October 1.
